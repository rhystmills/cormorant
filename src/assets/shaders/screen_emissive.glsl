    ...
    vec2 screenUV = uv;
    screenUV += vec2(0.0, -0.04); // hardcoded offset for screen content - was in texture offset
    screenUV *= vec2(1, 1.1); // hardcoded zoom for screen content - was in texture repeat

    // Hardcoded vals for wip 11
    // screenUV += vec2(-0.03, -0.18); // hardcoded zoom for screen content - was in texture offset
    // screenUV *= vec2(1.06, 1.5); // hardcoded zoom for screen content - was in texture repeat
