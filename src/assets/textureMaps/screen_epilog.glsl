    ...
    float DEFAULT_SPECULAR_COEFFICIENT = 0.04;
    ...
    // This line caused trouble: totalEmissiveRadiance *= 1.0 - BRDF_Specular_GGX_Environment( geometry.viewDir, geometry.normal, vec3( DEFAULT_SPECULAR_COEFFICIENT ), specularRoughness);
